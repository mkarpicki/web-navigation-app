...
describe('Main page (form page)', function() {
    ...
    describe('get route button', function () {
        ...
        it('should redirect to search results page after entering start and destination positions', function() {
            ...
            element.all(by.css(helpers.SELECTORS.INPUT_FROM)).sendKeys(fromPosition);
            element.all(by.css(helpers.SELECTORS.INPUT_TO)).sendKeys(toPosition);
            element.all(by.css(helpers.SELECTORS.BTN_GET_ROUTE)).first().click();
        ...
        describe('and middle way points are added', function () {
            ...
            it('should redirect to search results page with middle way points', function () {
                ...
                element.all(by.css(helpers.SELECTORS.BTN_ADD_WAY_POINT)).first().click();
                element.all(by.css(helpers.SELECTORS.INPUT_WAY_POINT + 0)).sendKeys(wayPoints[0]);

                element.all(by.css(helpers.SELECTORS.BTN_ADD_WAY_POINT)).first().click();
                element.all(by.css(helpers.SELECTORS.INPUT_WAY_POINT + 1)).sendKeys(wayPoints[1]);
    ...
    describe('clear button', function () {
        ...
        it('should provide clear functionality that rests form', function () {
            ...
            expect(element(by.css(helpers.SELECTORS.INPUT_FROM)).getAttribute('value')).toEqual(fromPosition);
            expect(element(by.css(helpers.SELECTORS.INPUT_TO)).getAttribute('value')).toEqual(toPosition);

            element.all(by.css(helpers.SELECTORS.BTN_CLEAR)).first().click();

            expect(element(by.css(helpers.SELECTORS.INPUT_FROM)).getAttribute('value')).toEqual('');
            expect(element(by.css(helpers.SELECTORS.INPUT_TO)).getAttribute('value')).toEqual('');
        ...
        describe('and middle way points are added', function () {
            ...
            it('should provide clear functionality that rests form (incl. way points)', function () {
                ...
                expect(element(by.css(helpers.SELECTORS.INPUT_FROM)).getAttribute('value')).toEqual(fromPosition);
                expect(element(by.css(helpers.SELECTORS.INPUT_TO)).getAttribute('value')).toEqual(toPosition);
                expect(element(by.css(helpers.SELECTORS.INPUT_WAY_POINT + 0)).getAttribute('value')).toEqual(wayPoints[0]);
                ...
                var wayPoint0 = element(by.css(helpers.SELECTORS.INPUT_WAY_POINT + 0));
    ...
    it('should allow to remove add way points', function () {
        ...
        element.all(by.css(helpers.SELECTORS.BTN_REMOVE_WAY_POINT)).last().click();
